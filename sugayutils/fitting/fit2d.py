...
import emcee
from ..stat import weightedstats

__all__ = ['FitGauss2d', 'FitExponential2d']
...
class FitGauss2d(FitImage):
    ...
    def get_bounds(self):
        ...
        bound1 = np.array([1.0, 100.0, 20.0, 20.0, 10.0])
    ...
    def initialize_param(self):
        ...
        radius = weightedstats.std(
            np.arange(self.image.shape[0]), np.nansum(self.image, axis=0)
        )
